    ...
    <div class="torso">
      ...
      <div class="plate">
        <span class="red_top" /><span class="red_center" /><span
          class="red_bottom"
        /><span class="blue" /><span class="gray" />
      </div>
    </div>
    <div class="hand left"><span class="hand" /></div>
    <div class="hand right animation-right"><span class="hand" /></div>
    <div class="legs"><span class="left" /><span class="right" /></div>
    <div class="boots"><span class="left" /><span class="right" /></div>
    <div class="sword animation-left">
      <span class="handle" /><span class="light" />
    </div>
  </div>
</template>
